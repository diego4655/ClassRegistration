...
- Create Angular project with ng: `ng new classregistration.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`classregistration.client.esproj`).
